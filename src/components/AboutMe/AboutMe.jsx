import './AboutMe.css'
import imgAgos from '../../assets/aboutme.jpg';
...
const AboutMe = () => {
    ...
    return(
        ...
        <div className='containerImgText'>
            ...
            <p className='textImg'>My name is Agostina Schenone, I’m an argentinian photographer based in St. Moritz, Switzerland and available worldwide.</p>
        </div>
        <div className='containerText'>
            ...
            If you have any questions, please contact me:  info@agoschenone.com
            </p>
        </div>
        </div>
    )
